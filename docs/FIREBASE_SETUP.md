...
- `/admin` เปิดเฉพาะ Admin เจ้าของโครงการ ใช้เพิ่ม ค้นหา และลบอีเมลผู้มีสิทธิ์ดู Dashboard
...
- Admin สองบัญชีอ่าน Dashboard, จัดการ `dashboard_members` และอัปเดตค่ากลางได้
...
8. ตรวจ Desktop/Mobile และทดสอบลิงก์จาก Messenger ว่ามีคำแนะนำให้เปิด Safari/Chrome
