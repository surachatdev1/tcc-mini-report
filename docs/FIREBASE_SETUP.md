...
- `/admin` เปิดเฉพาะ Admin เจ้าของโครงการ ใช้จัดการอีเมลผู้มีสิทธิ์ดู Dashboard และลบแบบประเมินเป็นรายชุดหรือทั้งหมด
...
- Admin สองบัญชีอ่าน Dashboard, จัดการ `dashboard_members`, ลบแบบประเมิน และอัปเดตค่ากลางได้
- การลบหนึ่งรายการหมายถึงลบเอกสาร `submissions/{id}` และ `submission_assessors/{id}` คู่กัน จึงนำคะแนน คำตอบ เหตุผลประกอบ และข้อมูลผู้ประเมินของชุดนั้นออกทั้งหมด
- ระบบล้าง `benchmarks` หลังลบแบบประเมินเพื่อป้องกันการแสดงค่ากลางเดิมที่คลาดเคลื่อน Admin สามารถสร้างค่ากลางใหม่จาก Dashboard ได้
...
8. เปิดส่วน “จัดการรายการแบบประเมิน” ใน `/admin` ทดสอบกดยกเลิกในหน้าต่างยืนยันก่อน แล้วจึงลบแบบประเมินทดสอบหนึ่งชุด
9. ยืนยันว่าผลประเมินและข้อมูลผู้ประเมินของชุดนั้นหายจาก Admin/Dashboard และแบบประเมินชุดอื่นยังอยู่ครบ
