...
Admin เจ้าของโครงการ
  └─ /admin
       ...
       └─ ค้นหาและลบแบบประเมินรายชุดหรือทั้งหมด พร้อมข้อมูลผู้ประเมินที่เชื่อมโยง
```
...
- Admin ลบผลประเมินทั้งเอกสารได้ แต่แก้ไขคะแนน คำตอบ หรือข้อมูลบริบทไม่ได้
- การลบหนึ่งชุดใช้ atomic batch ลบทั้ง `submissions` และ `submission_assessors`
- การลบทั้งหมดแบ่งครั้งละ 200 ชุด หรือไม่เกิน 400 delete operations ต่อ Firestore batch
- ล้าง `benchmarks` หลังการลบ เพื่อไม่เผยแพร่ค่ากลางที่คำนวณจากข้อมูลเก่า
...
| บทบาท | แบบประเมิน | Dashboard | จัดการ Viewer | ลบแบบประเมิน | อัปเดตค่ากลาง |
|---|---:|---:|---:|---:|---:|
