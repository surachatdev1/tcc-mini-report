...
- ชื่อ บทบาท ตำแหน่ง และเบอร์โทรผู้ประเมินเก็บแยกใน `submission_assessors/{idempotencyKey}`; admin/member รายบุคคลเห็นได้ แต่สิทธิ์ระดับโดเมนเห็นเฉพาะข้อมูลสรุป
