...
เลือกโรงเรียน/หน่วยงาน สังกัด จังหวัด ประเภท ผู้รับผิดชอบ ระดับผล และช่วงวันที่ประเมิน แล้วกดค้นหา ระบบใช้ทุกเงื่อนไขร่วมกันกับตาราง สรุปผล และ Excel รายการแบ่งหน้าละ 20 ชุด แต่ Excel ส่งออกทุกชุดที่ตรงกับเงื่อนไข ผู้ที่ไม่มีสิทธิ์ดูข้อมูลส่วนบุคคลจะไม่เห็นตัวกรองชื่อผู้รับผิดชอบ
